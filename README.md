...
To find the optimal parameters, we have to go through each diagonal of the map. Rather, extract the currents in the middle of the diagonals (**Search currents**).
